...
<ol class="breadcrumb bc-3" >
    <li>
        <a href="<?php echo e(route('chief.list')); ?>">Approval List</a>
    </li>
    <li class="active">
    	<a>Detail Ticket</a>
    </li>
	    ...
	    <div class="panel panel-default">
	        ...
	        <div class="panel-body">
		                    	...
		                    	<div class="col-md-6" style="padding-right:30px">
		                    		<div class="form-group" style="padding-bottom: 20px;">
					                    <div class="col-md-12">
						                    ...
						                    1. Significant Development Needed; <br>
						                    2. Development Needed; <br>
						                    3. Partially Meet Expectation; <br>
						                    4. Meet Expectation; <br>
						                    5. Exceed Expectation</i></span>
						                </div>
					                </div>	
		                    	</div>
	            ...
	            <div class="form-group text-center">
	            	<a href="<?php echo e(route('chief.list')); ?>" type="button" class="btn btn-round btn-info" title="back">
	            		<span class="glyph-icon icon-arrow-left"></span>
	            	</a>
	            	&nbsp;
	            	<?php if( $detail->approval_chief == 0 ): ?>
	            	<a href="#modal_approval" type="button" data-url="<?php echo e(route('chief.approved.ticket',$detail->id)); ?>" data-toggle="modal" class="btn btn-round btn-success btn_modal_approved" title="Approved">
                    	<span class="glyph-icon icon-check"></span>
                    </a>
                    &nbsp;
                    <a href="#modal_reject" type="button" data-url="<?php echo e(route('chief.reject.ticket',$detail->id)); ?>" data-toggle="modal" class="btn btn-round btn-danger btn_modal_reject" title="Reject">
