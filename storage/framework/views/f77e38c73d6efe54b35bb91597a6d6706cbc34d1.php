...
<div class="panel">
	<div class="panel-body">
		<div class="title-hero">
			<h4><strong>Hiring Brief List</strong></h4>
		</div>
									    ...
									    <?php if( $now < $data->hiring_briefs->date_schedule ): ?>
											...
											<?php elseif( $data->hiring_briefs->approval_hiring_by_hrbp == 1 ): ?>
												...
												<?php if( $approval <= $schedule ): ?>
													<?php if( $total == 2 ): ?>
														<span class="bs-label label-success"><strong>SLA 1 Day</strong></span>
													<?php elseif( $total == 1 ): ?>
										...
										<?php elseif( $now >= $data->hiring_briefs->date_schedule ): ?>
											...
											<?php elseif( $data->hiring_briefs->approval_hiring_by_hrbp == 1 ): ?>
												...
												<?php elseif( $approval > $schedule ): ?>
													<span class="bs-label label-danger"><strong>SLA + <?php echo e($total); ?> Days</strong></span>
												<?php endif; ?>
