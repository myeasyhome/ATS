			...
			<table id="datatable-responsive" class="table table-striped table-bordered responsive no-wrap" cellspacing="0" width="100%">
				...
				<tbody>
				    ...
				    <tr>
					    ...
					    <td><a href="<?php echo e(route('gh.detail.ticket',$ticket->id)); ?>"><?php echo e($ticket->position_name); ?></a></td>
					    ...
					    <td class="text-center">
					    	<?php if($ticket->approval_GH > 0): ?>
					    		<?php if( $ticket->approval_GH == 1 ): ?>
					    		...
					    		<?php endif; ?>
					    	<?php else: ?>
					    		<a href="<?php echo e(route('gh.detail.ticket',$ticket->id)); ?>" type="button" class="bs-label label-yellow"><span><strong>need approval</strong></span></a>
