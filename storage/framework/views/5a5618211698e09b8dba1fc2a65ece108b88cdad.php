					<div class="row" style="padding-bottom: 20px;">
		            	<div class="col-md-6">
		            		<div class="form-group">
			                    ...
			                    <div class="col-md-8">
			                            <input type="text" name="supervisor_title" value="<?php echo e($data->ticket_jd_details->supervisor); ?>" class="form-control" id="supervisor_title" placeholder="Input Supervisor Title">
			                    </div>
			                </div>
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="col-md-8">
			                            <input type="text" name="incumbent" value="<?php echo e($data->ticket_jd_details->incumbent_name); ?>" class="form-control" id="incumbent" placeholder="Input Incumbent Name">
			                    </div>
			                </div>
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="col-md-8">
			                            <input type="text" name="supervisor_name" value="<?php echo e($data->ticket_jd_details->supervisor_name); ?>" class="form-control" id="supervisor_name" placeholder="Input Supervisor Name">
			                    </div>
			                </div>
							...
							<div class="form-group">
			                    ...
			                    <div class="col-md-8">
			                        <textarea class="form-control" rows="5" cols="49" id="role_purpose" name="role_purpose"><?php echo e($data->ticket_jd_details->role_purpose); ?></textarea>
			                    </div>
			                </div>
			            </div>
		                ...
		                <div class="col-md-6">
		                	<div class="form-group">
			                    ...
			                    <div class="col-md-8">
			                        <input type="text" name="direct_sub" value="<?php echo e($data->ticket_jd_details->direct_sub); ?>" class="form-control" id="direct_sub" placeholder="Input Direct Sub Ordinate">
			                    </div>
			                </div>
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="col-md-8">
			                        <input type="text" name="indirect_sub" value="<?php echo e($data->ticket_jd_details->indirect_sub); ?>" class="form-control" id="indirect_sub" placeholder="Input Indirect Sub Ordinate">
			                    </div>
			                </div>
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="col-md-8">
			                        ...
			                        <?php if( Auth::user()->grade == 7 ): ?>
			                        	...
			                        	<?php if( $data->ticket_jd_details->job_level == 'Fresh Graduate' ): ?>
			                        	...
			                        	<?php elseif( $data->ticket_jd_details->job_level == 'Mid-Senior Staff' ): ?>
			                        		<option value="Fresh Graduate">Fresh Graduate</option>
				                        	<option value="Mid-Senior Staff" selected>Mid-Senior Staff</option>
				                        	<option value="Manager/Specialist">Manager/Specialist</option>
				                        	<option value="Division Head/Expert">Division Head/Expert</option>
			                        	<?php elseif( $data->ticket_jd_details->job_level == 'Manager/Specialist' ): ?>
			                        		<option value="Fresh Graduate">Fresh Graduate</option>
				                        	<option value="Mid-Senior Staff">Mid-Senior Staff</option>
				                        	<option value="Manager/Specialist" selected>Manager/Specialist</option>
				                        	<option value="Division Head/Expert">Division Head/Expert</option>
			                        	<?php elseif( $data->ticket_jd_details->job_level == 'Division Head/Expert' ): ?>
			                        		<option value="Fresh Graduate">Fresh Graduate</option>
				                        	<option value="Mid-Senior Staff">Mid-Senior Staff</option>
				                        	<option value="Manager/Specialist">Manager/Specialist</option>
			                        ...
			                        <?php elseif( Auth::user()->grade == 8 ): ?>
			                        	...
			                        	<?php elseif( $data->ticket_jd_details->job_level == 'Division Head/Expert' ): ?>
				                        	...
				                        	<option value="Division Head/Expert" selected>Division Head/Expert</option>
				                        	<option value="Group Head">Group Head</option>
				                        <?php elseif( $data->ticket_jd_details->job_level == 'Group Head' ): ?>
			                        		<option value="Fresh Graduate">Fresh Graduate</option>
				                        	<option value="Mid-Senior Staff">Mid-Senior Staff</option>
				                        	<option value="Manager/Specialist">Manager/Specialist</option>
				                        	<option value="Division Head/Expert">Division Head/Expert</option>
	                        		...
	                        		<div class="col-md-8">
					                    ...
					                    <div class="col-md-12" >
					                         <textarea class="form-control" id="editor_exp" name="qualification">
					                         	<?php echo e($data->ticket_jd_details->qualification); ?>
		                        		...
		                        		<div class="col-md-8">
						                    ...
						                    <div class="col-md-12" >
						                        <textarea class="form-control" id="responsibility" name="responsibility">
						                        	<?php echo e($data->ticket_jd_details->responsibility); ?>
				                        ...
				                        <table class="table table-striped table-bordered">
				                            ...
				                            <tbody>
				                                <tr>
				                                    ...
				                                    <td><input class="form-control" type="number" name="soft[0]" min="1" max="5" required value="<?php echo e($soft[0]); ?>"></td>
				                                </tr>
				                                <tr>
				                                    <td>Making Difference</td>
				                                    <td><input class="form-control" type="number" name="soft[1]" min="1" max="5" required value="<?php echo e($soft[1]); ?>"></td>
				                                </tr>
				                                <tr>
				                                    <td>People Management</td>
				                                    <td><input class="form-control" type="number" name="soft[2]" min="1" max="5" required value="<?php echo e($soft[2]); ?>"></td>
				                                </tr>
				                                <tr>
				                                    <td>Accelerate Business And Customer</td>
				                                    <td><input class="form-control" type="number" name="soft[3]" min="1" max="5" required value="<?php echo e($soft[3]); ?>"></td>
				                                </tr>
				                                <tr>
				                                    <td>Translating Strategy into Action</td>
				                                    <td><input class="form-control" type="number" name="soft[4]" min="1" max="5" required value="<?php echo e($soft[4]); ?>"></td>
				                                </tr>
				                                <tr>
				                                    <td>Decisiveness</td>
				                                    <td><input class="form-control" type="number" name="soft[5]" min="1" max="5" required value="<?php echo e($soft[5]); ?>"></td>
				                                </tr>
				                                <tr>
				                                    <td>Cultivate  Networks & Partnerships</td>
				                                    <td><input class="form-control" type="number" name="soft[6]" min="1" max="5" required value="<?php echo e($soft[6]); ?>"></td>
				                                </tr>
				                            </tbody>
				                        </table>
				                        ...
				                        <table class="table table-striped table-bordered" id="table_hard_competencies">
				                            ...
				                            <tbody>
				                            	<?php $__currentLoopData = $hard; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $array => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					                				<tr class="row<?php echo e($array); ?>" id="<?php echo e($array); ?>">
				                						<td>
				                							<input class="form-control" type="text" name="hard[]" required value="<?php echo e(ucwords($value)); ?>">
					                					</td>
					                					<td>
					                						<input class="form-control" type="number" name="value[]" min="1" max="5" required value="<?php echo e($hard_value[$array]); ?>">
					                					</td>
					                					<td>
					                						...
					                						<?php else: ?>
					                							<button type="button" id=<?php echo e($array); ?> class="btn btn-danger edit_remove">X</button>
					                						<?php endif; ?>
					                					</td>		
					                				</tr>
