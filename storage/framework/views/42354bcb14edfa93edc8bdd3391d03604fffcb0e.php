...
<ol class="breadcrumb bc-3" >
    <li>
        <a href="<?php echo e(route('lm2.approval')); ?>">Approval Ticket</a>
    </li>
    <li class="active">
    	<a>Detail Ticket</a>
    </li>
	    ...
	    <div class="panel panel-default">
	        ...
	        <div class="panel-body">
	                    	...
	                    	<div class="row" style="padding-left: 10px">
	                    		...
	                    		<div class="col-md-6">
		                    			...
		                    			<div class="form-group">
			                    			...
			                    			<p class="col-md-12">
			                    				<?php if( $detail->ticket_erf_details->employee_status == 'Contract' ): ?>
			                    					<?php echo e($detail->ticket_erf_details->contract_duration); ?>
	                    	...
	                    	<div class="row" style="padding-left: 10px">
	                    		<div class="col-md-6">
		                    			...
		                    			<div class="form-group">
			                    			...
			                    			<p class="col-md-12"><?php echo e($detail->ticket_jd_details->incumbent_name); ?></p>
		                    			</div>
		                    			<div class="form-group">
	                    		...
	                    		<div class="col-md-6">
	                    				...
	                    				<div class="form-group">
			                    			...
			                    			<p class="col-md-12"><?php echo e($detail->ticket_jd_details->direct_sub); ?></p>
		                    			</div>
		                    			<div class="form-group">
			                    			<label class="col-md-12" style="margin-bottom: 0px">Indirect Sub Ordinate</label>
			                    			
			                    			<p class="col-md-12"><?php echo e($detail->ticket_jd_details->indirect_sub); ?></p>
		                    			</div>
		                    			<div class="form-group">
		                    			...
		                    			<div class="form-group">
			                    			...
			                    			<p class="col-md-12">
			                    				<?php if($detail->ticket_jd_details->min_education=='S1'): ?>
			                    					Bachelor's degree graduate
			                    				<?php elseif($detail->ticket_jd_details->min_education=='S2'): ?>
			                    					Master's degree graduate
			                    				<?php elseif($detail->ticket_jd_details->min_education=='S3'): ?>
	            ...
	            <div class="form-group text-center">
	            	<a href="<?php echo e(route('lm2.list')); ?>" type="button" class="btn btn-round btn-info" title="back">
