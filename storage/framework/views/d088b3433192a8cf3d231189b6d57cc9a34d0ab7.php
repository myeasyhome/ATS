...
<ol class="breadcrumb bc-3" >
    <li>
        <a href="<?php echo e(route('gh.list')); ?>">Approval List</a>
    </li>
    <li class="active">
    	<a>Detail Ticket</a>
    </li>
	    ...
	    <div class="panel panel-default">
	        ...
	        <div class="panel-body">
	            ...
	            <div class="form-group text-center">
	            	<a href="<?php echo e(route('gh.list')); ?>" type="button" class="btn btn-round btn-info" title="back">
	            		<span class="glyph-icon icon-arrow-left"></span>
	            	</a>
	            	&nbsp;
	            	<?php if( $detail->approval_GH == 0 ): ?>
	            	<a href="#modal_approval" type="button" data-url="<?php echo e(route('gh.approved.ticket',$detail->id)); ?>" data-toggle="modal" class="btn btn-round btn-success btn_modal_approved" title="Approved">
                    	<span class="glyph-icon icon-check"></span>
                    </a>
                    &nbsp;
                    <a href="#modal_reject" type="button" data-url="<?php echo e(route('gh.reject.ticket',$detail->id)); ?>" data-toggle="modal" class="btn btn-round btn-danger btn_modal_reject" title="Reject">
