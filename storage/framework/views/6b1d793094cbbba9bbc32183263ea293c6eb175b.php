<?php $__env->startSection('title',ucwords(Request::segment(2).' ticket')); ?>
...
<script type="text/javascript">	
		...
		$('#wizard').steps({
		  ...
		  // //       	rules: {
				// //         position_name: {
				// //             remote: {
				// //                 url: '<?php echo e(url('checkPosition')); ?>',
				// // 				type : 'post',
				// //             }
				// //         }
				// //     },
...
<!-- Dependency Dropdown -->
<script>
	var url = '<?php echo e(env('APP_URL')); ?>';
	function change_dir() {
...
<script type="text/javascript" src="<?php echo e(asset('assets/widgets/uniform/uniform.js')); ?>"></script>
<script>
	/* Checkbox */
	$(function() {
...
<?php if( Request::segment(2) == 'create' ): ?>
	<ol class="breadcrumb bc-3" >
	    <li>
	        <a href="<?php echo e(route('ticket')); ?>"><i class="fa-home"></i>Ticket</a>
	    </li>
	    <li class="active">
	        <a href="<?php echo e(route('create.ticket')); ?>">New Request</a>
	    </li>
	</ol>
	    ...
	    <div class="col-md-12">
		    <div class="panel panel-default">
		        ...
		        <div class="panel-body">
			        ...
			        <form role="form" action="<?php echo e(route('store.ticket')); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="form_ticket">
			        <?php echo csrf_field(); ?>
			        	<div id="wizard">
		                    <h2>Employee Requisition Form</h2>
		                    <section>
		                    	<?php echo $__env->make('Line_Manager1.form_erf', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		                    </section>

		                    <h2>Job Description</h2>
		                    <section>
		                        <?php echo $__env->make('Line_Manager1.form_jd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		                    </section>

		                    <h2>Verified By</h2>
		                    <section>
		                        <?php echo $__env->make('Line_Manager1.form_LOA', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		                    </section>
		                </div>
		            </form>
		        </div>
	...
	<div class="row">
	    <div class="col-md-12">
		    <div class="panel panel-default">
		        ...
		        <div class="panel-body">
			        <form role="form" action="<?php echo e(route('update.ticket',$id)); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="form_ticket">
			        <?php echo csrf_field(); ?>
			        <?php echo method_field('PATCH'); ?>
			        	<div id="wizard-edit">
		                    <h2>Employee Requisition Form</h2>
		                    <section>
		                    	<?php echo $__env->make('Line_Manager1.edit_form_erf', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		                    </section>

		                    <h2>Job Description</h2>
		                    <section>
		                        <?php echo $__env->make('Line_Manager1.edit_form_jd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		                    </section>

		                    <h2>Verified By</h2>
		                    <section>
		                        <?php echo $__env->make('Line_Manager1.edit_form_LOA', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		                    </section>
		                </div>
		            </form>
		        </div>
...
<?php elseif( Request::segment(2) == 're-approval' ): ?>
	...
	<div class="row">
	    <div class="col-md-12">
		    <div class="panel panel-default">
		        ...
		        <div class="panel-body">
			        <form role="form" action="<?php echo e(route('re_approval.ticket',$id)); ?>" method="post" enctype="multipart/form-data" class="form-horizontal" id="form_ticket">
			        <?php echo csrf_field(); ?>
			        <?php echo method_field('PATCH'); ?>
			        	<div id="wizard-edit">
		                    <h2>Employee Requisition Form</h2>
