	                    	...
	                    	<div class="row">
	                    		<div class="col-md-6">
	                    			<fieldset class="the-fieldset">
		                    			...
		                    			<div class="form-group">
			                    			<label class="col-md-4">Direct Rerporting</label>
			                    			<label class="col-md-1">:</label>
			                    			<label class="col-md-7">{{ ucwords($detail->ticket_erf_details->direct_report) }}</label>
		                    			</div>
		                    			<div class="form-group">
			                    			<label class="col-md-4">Department</label>
			                    			<label class="col-md-1">:</label>
			                    			<label class="col-md-7">{{ $detail->department }}</label>
		                    			</div>
		                    			<div class="form-group">
		                    			...
		                    			<div class="form-group">
			                    			...
			                    			<label class="col-md-1">:</label>
			                    			<label class="col-md-7">{{ $detail->ticket_erf_details->qty }}</label>
		                    			</div>
		                    			<div class="form-group">
			                    			<label class="col-md-4">Nature Of Request</label>
			                    			<label class="col-md-1">:</label>
			                    			<label class="col-md-7">{{ $detail->ticket_erf_details->nature_of_request }}</label>
		                    			</div>
		                    			<div class="form-group">
	                    		...
	                    		<div class="col-md-6">
	                    			<fieldset class="the-fieldset">
		                    			<div class="form-group">
			                    			<label class="col-md-4">Source Of Candidate</label>
			                    			<label class="col-md-1">:</label>
			                    			<label class="col-md-7">{{ $detail->ticket_erf_details->source_candidate }}</label>
		                    			</div>
		                    			<div class="form-group">
			                    			<label class="col-md-4">Special Treatment</label>
			                    			<label class="col-md-1">:</label>
			                    			<label class="col-md-7">{{ $detail->ticket_erf_details->special_treatment }}</label>
		                    			</div>
		                    			<div class="form-group">
	                    	...
	                    	<div class="row">
	                    		<div class="col-md-6">
	                    			<fieldset class="the-fieldset">
		                    			...
		                    			<div class="form-group">
			                    			<label class="col-md-4">Organization Development Analyst Report To</label>
			                    			<label class="col-md-1">:</label>
			                    			<label class="col-md-7">{{ $detail->ticket_jd_details->direct_report }}</label>
		                    			</div>
		                    			<div class="form-group">
			                    			<label class="col-md-4">Organization Development Manager</label>
			                    			<label class="col-md-1">:</label>
			                    			<label class="col-md-7">{{ ucwords($detail->ticket_jd_details->indirect_report) }}</label>
		                    			</div>
	                    			</fieldset>
	                    		</div>
	                    		...
	                    		<div class="col-md-6">
	                    			<fieldset class="the-fieldset">
		                    			...
		                    			<div class="form-group">
			                    			<label class="col-md-4">Internal (Outside Of Function)</label>
			                    			<label class="col-md-1">:</label>
		                    			...
		                    			<div class="form-group">
			                    			...
			                    			<label class="col-md-1">:</label>
			                    			<label class="col-md-7">{{ $detail->ticket_jd_details->experience }}</label>
		                    			</div>
	                    			</fieldset>
	                    		</div>
	                    	</div>
<br><br>
	            ...
	            <a href="{{ route('hrbp.approval') }}" type="button" class="btn btn-primary">Back</a>
