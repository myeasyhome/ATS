	    ...
	    <div class="panel panel-default">
	        ...
	        <div class="panel-body">
	                    		...
	                    		<div class="col-md-6">
	                    			{{-- <fieldset class="the-fieldset"> --}}
		                    			...
		                    			<div class="form-group">
			                    			...
			                    			{{-- <label class="col-md-1">:</label> --}}
			                    			<p class="col-md-12">
			                    				@if ( $detail->ticket_erf_details->employee_status == 'Contract' )
			                    					{{ $detail->ticket_erf_details->contract_duration }}
			                    				@else
			                    					-
			                    				@endif
			                    			</p>
		                    			...
		                    			<div class="form-group">
			                    			<label class="col-md-12" style="margin-bottom: 0px">Reason</label>
			                    			{{-- <label class="col-md-1">:</label> --}}
	                    		...
	                    		<div class="col-md-6">
	                    			{{-- <fieldset class="the-fieldset"> --}}
		                    			...
		                    			<div class="form-group">
			                    			...
			                    			{{-- <label class="col-md-1">:</label> --}}
			                    			<p class="col-md-12">{{ $detail->ticket_jd_details->incumbent_name }}</p>
		                    			</div>
		                    			<div class="form-group">
	                    		...
	                    		<div class="col-md-6">
	                    			{{-- <fieldset class="the-fieldset"> --}}
	                    				<div class="form-group">
			                    			...
			                    			{{-- <label class="col-md-1">:</label> --}}
			                    			<p class="col-md-12">{{ $detail->ticket_jd_details->direct_sub }}</p>
		                    			</div>
		                    			<div class="form-group">
			                    			<label class="col-md-12" style="margin-bottom: 0px">Indirect Sub Ordinate</label>
			                    			{{-- <label class="col-md-1">:</label> --}}
			                    			<p class="col-md-12">{{ $detail->ticket_jd_details->indirect_sub }}</p>
		                    			</div>
		                    			<div class="form-group">
		                    			...
		                    			<div class="form-group">
			                    			...
			                    			{{-- <label class="col-md-1">:</label> --}}
			                    			<p class="col-md-12">
			                    				@if($detail->ticket_jd_details->min_education=='S1')
			                    					Bachelor's degree graduate
			                    				@elseif($detail->ticket_jd_details->min_education=='S2')
			                    					Master's degree graduate
			                    				@elseif($detail->ticket_jd_details->min_education=='S3')
	            ...
	            <div class="form-group text-center">
	            	<a href="{{ route('lm2.list') }}" type="button" class="btn btn-round btn-info" title="back">
	            		<span class="glyph-icon icon-arrow-left"></span>
	            	</a>
	            	&nbsp;
	            	@if ( $detail->approval_lm2 == 0 )
	            	<a href="#modal_approval" type="button" data-url="{{ route('approved.ticket',$detail->id) }}" data-toggle="modal" class="btn btn-round btn-success btn_modal_approved" title="Approved">
                    	<span class="glyph-icon icon-check"></span>
                    </a>
                    &nbsp;
                    <a href="#modal_reject" type="button" data-url="{{ route('reject.ticket',$detail->id) }}" data-toggle="modal" class="btn btn-round btn-danger btn_modal_reject" title="Reject">
